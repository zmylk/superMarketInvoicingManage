			...
			<div class="panel-body table_add">
				<table class="table half-table">
					...
					<tr>
						...
						<td>
							<div class="form-group ">
								<input type="text" class="form-control"  placeholder="输入商品数量" name="saleNumber" value="${brand.saleNumber}">
							</div>
						</td>
						<th><span class="required">*</span>售价</th>
						<td>
							<div class="form-group ">
								<input type="text" class="form-control"  placeholder="商品单价"  name="salePrice" value="${brand.salePrice}">
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="form-group ">
								<input type="text" class="form-control"  placeholder="应收金额" name="receivableAmount" value="${brand.receivableAmount}">
							</div>
						</td>
						<th><span class="required">*</span>实收金额</th>
						<td>
							<div class="form-group ">
								<input type="text" class="form-control"  placeholder="收到金额"  name="paidAmount" value="${brand.paidAmount}">
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="form-group ">
								<input type="text" class="form-control"  placeholder="找零金额" name="changeAmount" value="${brand.changeAmount}">
							</div>
						</td>
						<th></th>
						<td>
