...
public class SaleRecordServiceImpl  implements SaleRecordService{
	 ...
	 */
	@Override
	public PageInfo<SaleRecordMonMoneyEntity> getmoneyList(PageInfo<SaleRecordMonMoneyEntity> pageInfo, Map<String, Object> params) {
		List<SaleRecordMonMoneyEntity> list = saleRecordMapper.getmoneyList(params,
				new RowBounds(pageInfo.getStart(), pageInfo.getPageSize()));
		//这里调用不对
		Integer total = saleRecordMapper.getListCount(params);
		pageInfo.setRows(list);
